...
1. What is default OS used to run the virtual environment for codespaces. ***(1 mark)*** <br></br>
...
3. Why must we commit and sync our current work on source control? ***(1 mark)*** <br></br>
